      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 w-80 ">
        <div className="bg-blue-500  border rounded-lg">
          <h1 className="mt-12 text-white p-4">
            <b>WELCOME TO APPLAND E-COMMERCE</b>
          </h1>

          <form className="mb-6">
            <div className=" bg-blue-700  cursor-pointer text-white px-4 rounded hover:bg-blue-800 mt-10 py-2 mb-2 ml-32 mr-32" onClick={handleFacebook}>
             <i className="fa-brands fa-facebook p-2">  </i> 
             SING IN WITH FACEBOOK
            </div>
            <div className=" bg-blue-700  cursor-pointer text-white px-4 rounded hover:bg-blue-800 mt-10 py-2 mb-2 ml-32 mr-32"  onClick={handleGoogle}>
